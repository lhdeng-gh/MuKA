    ...
    **kwargs,
    ...
    if is_mm_model(model_path):
        ...
        if "lora" in model_name.lower() and model_base is not None:
            ...
            #         )
            #     )
            # modified: according to `vila_train.py`, it seems VILA uses the name `LlavaLlamaModel` instead of `LlavaLlamaForCausalLM` 
            ...
            assert not unexpected_keys, f'failed to load those keys into model: {unexpected_keys}'
